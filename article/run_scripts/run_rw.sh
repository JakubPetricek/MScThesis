...
#output: ds_Tmax, Q90, Q75, Q25
python3 ../1_daily_Tmax.py \
&& echo " ... Temperature analysis done"

python3 ../1_geopotential_to_fourier.py \
&& python3 ../2_restore_GP.py \
&& echo " ... Fourier analysis done" \
&& python3 ../3_amplitudes.py \
&& echo "... Amplitude analysis done" \
&& python3 ../3_speed.py \
&& echo "... Speed analysis done" \
